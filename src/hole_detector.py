...
class Hole_detector:
    ...
    def callback(self,data):
        ...
        threshold=2000/128
        image_space=image_8[100:-100][100:-100]
        cv2.imshow("cropped",image_space)
        ...
        if M["m00"] !=0:
            # print("a")
            self.space_centroids.append([spaceX*spaceY,spaceX+100,spaceY+100])
            ...
            self.space_median_x=space_centroid_median[1]+100
            self.space_median_y=space_centroid_median[2]+100
            cv2.circle(image_c, (self.space_median_x, self.space_median_y), 7, (0, 255, 0), -1)
            cv2.putText(image_c, "empty space", (self.space_median_x - 20, self.space_median_y + 20),
